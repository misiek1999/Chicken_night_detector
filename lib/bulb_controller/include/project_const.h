...
namespace ProjectConst
{
    ...
    constexpr ProjectTypes::time_ms_t kMainLoopDelayBetweenUpdateGPIO = 100;  // 100ms
    constexpr ProjectTypes::time_ms_t kMainLoopDelayBetweenBlinkingErrorIndicator = 5000;  // 5s
